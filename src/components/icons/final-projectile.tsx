...
export function FinalProjectile({ size = 22, className, color }: IIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M9 19V21H1V19H9ZM3 5V3H7V5H9V17H1V5H3ZM3 15H5V9H3V15Z" fill={color} />
      <path d="M13 3V7H17" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke={color} />
      <path
        ...
        stroke={color}
      />
      <path d="M22 15V11H18" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke={color} />
      <path
