...
export function PlayerCultist2({ size = 20 }: IIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M2 3V6H1V3H2ZM10 3V6H9V3H10ZM5 3H4V2H3V1H8V2H7V3H6V4H5V3ZM3 2V3H2V2H3ZM9 2V3H8V2H9Z" fill="#E700B9" />
      <path d="M2 6V8H3V9H4V10H2V9H1V6H2ZM10 6V9H9V10H7V9H8V8H9V6H10Z" fill="#74006A" />
