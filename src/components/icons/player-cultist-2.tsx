...
export function PlayerCultist2({ size = 22 }: TIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="11" height="11" />
      <path d="M1.5 6V3M2.5 3V2M3 1.5H4.5H8M4 2.5H7M5 3.5H6M8.5 2V3M9.5 3V6" stroke="#E700B9" />
      <path d="M1.5 6V8.5H2.5V9.5H4M9.5 6V8.5H8.5V9.5H7" stroke="#74006A" />
